...
var CatSocket = (function () {
    function CatSocket(api_key, user_id, host, status_changed) {
        ...
        this._setHandlers = function (socket) {
        ...
        this._handleAck = function (event) {
        ...
        this.join = function (room, handler, last_timestamp) {
            if (handler) {
        ...
        this.broadcast = function (room, message) {
